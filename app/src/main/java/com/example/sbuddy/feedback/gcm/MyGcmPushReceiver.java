package com.example.sbuddy.feedback.gcm;
...
import com.example.sbuddy.feedback.activity.ChatRoomActivity;
import com.example.sbuddy.feedback.activity.GcmMainActivity;
...
import com.example.sbuddy.feedback.model.User;
        ...
        if (!isBackground) {
            ...
            try {
                ...
                if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                    ...
                    // app is in background. show the message in notification try
                    Intent resultIntent = new Intent(getApplicationContext(), GcmMainActivity.class);
